...
class ProductList extends Component {
  ...
  findAllBooks(currentPage) {
    currentPage -= 1;
    axios
      .get("http://localhost:8081/rest/books?pageNumber=" + currentPage + "&pageSize=" + this.state.booksPerPage + "&sortBy=price&sortDir=" + this.state.sortDir)
  ...
  searchData = currentPage => {
    currentPage -= 1;
    axios
      .get("http://localhost:8081/rest/books/search/" + this.state.search + "?page=" + currentPage + "&size=" + this.state.booksPerPage)
      .then(response => response.data)
      .then(data => {
        this.setState({
          books: data.content,
        ...
        <Card className={"border border-dark bg-dark text-white"}>
          <Card.Header>
            ...
            <div style={{ float: "right" }}>
              <InputGroup size="sm">
                <FormControl placeholder="Search" name="search" value={search} className={"info-border bg-dark text-white"} onChange={this.searchChange} />
                <InputGroup.Append>
              ...
              <thead>
                <tr>
                  ...
                  <th onClick={this.sortData}>
                    Price <div className={this.state.sortDir === "asc" ? "arrow arrow-up" : "arrow arrow-down"}> </div>
                  </th>
                  <th>Language</th>
                  <th>Genre</th>
                  <th>Actions</th>
...
const mapDispatchToProps = dispatch => {
  return {
    deleteBook: bookId => dispatch(deleteProduct(bookId)),
  };
};
